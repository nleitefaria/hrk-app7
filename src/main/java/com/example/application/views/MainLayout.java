 ...
 */
@PWA(name = "hrk-app7", shortName = "hrk-app7", enableInstallPrompt = false)
@Theme(themeFolder = "hrk-app7")
@PageTitle("Main")
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "hrk-app7 logo"));
        logoLayout.add(new H1("hrk-app7"));
    ...
    private List<Tab> createMenuItems() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
        		...
        		new MenuItemInfo("Countries", "la la-file", CountryView.class), //
        };
